...
### Added
- New function `set_struct/2`. This function allow you to convert an struct type into a mutation (json based) type in dgraph.
...
Internally it uses Dgraphs `set_json`. Thanks to @WolfDan.
